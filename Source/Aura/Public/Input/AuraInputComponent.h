	...
	PressedFuncType PressedFunc, ReleasedFuncType ReleasedFunc, HeldFuncType HeldFunc)
{
	...
	for (const FAuraInputAction& Action : InputConfig->AbilityInputActions)
	{
		...
		{
			if (PressedFunc) BindAction(Action.InputAction, ETriggerEvent::Started, Object, PressedFunc, Action.InputTag);// Action.InputTag is passed as params to the function
